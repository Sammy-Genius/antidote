    ...
    return ( 
        <>
            <div className="h-full w-full relative bg-black graph" id="art" ref={pinRec}>
                ...
                <p className='text-white text-4xl md:text-6xl lg:text-8xl voyage mt-[5%]'><span className='text-green-300 opacity-60 cancel italic'>Discover</span> the art world</p>
                </div>
